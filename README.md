# Hackney Repair API
This is the Repairs module of the Hackney API platform.  
This module is responsible for providing data on Hackney owned properties as well as provides and interface to create repairs for these properties.
